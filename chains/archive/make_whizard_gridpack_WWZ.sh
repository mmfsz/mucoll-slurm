#!/bin/bash
#SBATCH --job-name=whizard_gridpack_WWZ
#SBATCH --output=/oscar/data/mleblan6/mucoll/gridpacks/WWZ/gridpack.out
#SBATCH --error=/oscar/data/mleblan6/mucoll/gridpacks/WWZ/gridpack.err
